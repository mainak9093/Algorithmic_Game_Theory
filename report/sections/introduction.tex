...
open. So EFX can fail outright inside the binary-marginal chore domain,
whereas the allocation constructed below is always EF1, and becomes exactly
envy-free once at most one unit of subsidy per agent is paid.
That money is genuinely needed here is not obvious a priori but is
