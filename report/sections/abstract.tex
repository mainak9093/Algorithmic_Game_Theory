...
hence at most $n-1$ in total, with an allocation that is moreover EF1,
computable in polynomial time in the value-oracle model, and under no assumption on the cost functions beyond binary marginals ---
