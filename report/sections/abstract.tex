...
Our algorithm starts from an envy-free partial allocation produced by the algorithm of Tao et al.~\cite{TWYZ23}, assigns the remaining chores to distinct agents in a terminal strongly connected component, and determines the subsidised agents through a backward closure in the associated equality
graph.
\end{abstract}
