...
Consider three agents $N=\{1,2,3\}$ and three chores $M=\{x,y,z\}$. We work in cost form, writing \(c_i=-v_i\) for agent \(i\)'s non-negative cost function. Thus, an allocation \(\mathcal A=(A_1,\ldots,A_n)\) together with a subsidy vector \(p=(p_1,\ldots,p_n)\) is envy-free iff
\[
