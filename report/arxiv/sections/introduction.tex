...
% \noindent
% each of the four yielding a per-agent subsidy bound of one and a total subsidy bound of $n-1$. Note also that~\cite{LMS26} does not subsume~\cite{kawase2025towards} for the valuation class considered here:
