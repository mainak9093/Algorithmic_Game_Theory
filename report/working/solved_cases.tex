...
Conjecture~\ref{conj:main} holds in two restrictions of the model, by explicit
polynomial-time constructions. Both proofs run the same way: bound
...
For $n = 2$ the conjecture holds as well, with total subsidy at most $1$: by
Remark~\ref{rem:complement}, two-agent chore division is two-agent goods
division with the bundles swapped, and~\cite[Theorem~4]{BKNS22} applies. As
noted there, the reduction consumes the identity $\items \setminus \bundle{j} =
