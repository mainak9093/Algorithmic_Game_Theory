...
over~\cite{BDNSV20} on the goods side. A literature search has not turned up an
envy-freeness-with-subsidy result for chores under dichotomous costs: the
chores-and-money literature has concentrated on proportionality~\cite{GSW25},
and the binary-chores work that does exist is on the no-money
branch~\cite{TWYZ23}. That is a search rather than a proof of novelty and should
be repeated before circulation, but it is no longer a reason to hold off.
