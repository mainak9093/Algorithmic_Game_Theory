...
performed for this section (\texttt{updates/update\_14/rq1\_search.py}: zero
...
\texttt{updates/update\_6/guidedR3\_full.py}, cross-checked by
\texttt{updates/update\_14/reach\_sizes.py}) confirms the claim; an independent,
algorithm-free enumeration (\texttt{updates/update\_6/verify\_reach\_gap.py})
...
\end{proposition}
\begin{proof}[Verification]
A minimal instance is exhibited in \texttt{updates/update\_14/extend\_witness.py}:
